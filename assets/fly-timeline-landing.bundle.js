...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function tm(){return new Jt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Bc(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function nm(){return new Jt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Bc(),fragmentShader:`
	...
	`}var Uc=class extends In{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new Fa(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new $e(o,l),h=new hs(-1,1,1,-1,0,1),u=null,d=null,f=!1,g,_=null,p=[],m=!1;this.setSize=function(y,S){r.setSize(y,S),a.setSize(y,S);for(let M=0;M<p.length;M++){let E=p[M];E.setSize&&E.setSize(y,S)}},this.setEffects=function(y){p=y,m=p.length>0&&p[0].isRenderPass===!0;let S=r.width,M=r.height;for(let E=0;E<p.length;E++){let T=p[E];T.setSize&&T.setSize(S,M)}},this.begin=function(y,S){if(f||y.toneMapping===ri&&p.length===0)return!1;if(_=S,S!==null){let M=S.width,E=S.height;(r.width!==M||r.height!==E)&&this.setSize(M,E)}return m===!1&&y.setRenderTarget(r),g=y.toneMapping,y.toneMapping=ri,!0},this.hasRenderPass=function(){return m},this.end=function(y,S){y.toneMapping=g,f=!0;let M=r,E=a;for(let T=0;T<p.length;T++){let R=p[T];if(R.enabled!==!1&&(R.render(y,E,M,S),R.needsSwap!==!1)){let x=M;M=E,E=x}}if(u!==y.outputColorSpace||d!==y.toneMapping){u=y.outputColorSpace,d=y.toneMapping,l.defines={},Be.getTransfer(u)===Qe&&(l.defines.SRGB_TRANSFER="");let T=fv[d];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=M.texture,y.setRenderTarget(_),y.render(c,h),_=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.depthTexture&&r.depthTexture.dispose(),r.dispose(),a.dispose(),o.dispose(),l.dispose()}}var Sm=new Ht,Lu=new zi(1,1),bm=new Aa,Tm=new vl,Em=new Fa,im=[],sm=[],rm=new Float32Array(16),am=new Float32Array(9),om=new Float32Array(4);function Jr(s,e,t){let n=s[0];if(n<=0||n>0)return s;let i=e*t,r=im[i];if(r===void 0&&(r=new Float32Array(i),im[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function Wt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Xt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function zc(s,e){let t=sm[e];t===void 0&&(t=new Int32Array(e),sm[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function mv(s,e){let t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function gv(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Wt(t,e))return;s.uniform2fv(this.addr,e),Xt(t,e)}}function _v(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Wt(t,e))return;s.uniform3fv(this.addr,e),Xt(t,e)}}function xv(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Wt(t,e))return;s.uniform4fv(this.addr,e),Xt(t,e)}}function yv(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Wt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Xt(t,e)}else{if(Wt(t,n))return;om.set(n),s.uniformMatrix2fv(this.addr,!1,om),Xt(t,n)}}function vv(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Wt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Xt(t,e)}else{if(Wt(t,n))return;am.set(n),s.uniformMatrix3fv(this.addr,!1,am),Xt(t,n)}}function Mv(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Wt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Xt(t,e)}else{if(Wt(t,n))return;rm.set(n),s.uniformMatrix4fv(this.addr,!1,rm),Xt(t,n)}}function Sv(s,e){let t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function bv(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Wt(t,e))return;s.uniform2iv(this.addr,e),Xt(t,e)}}function Tv(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Wt(t,e))return;s.uniform3iv(this.addr,e),Xt(t,e)}}function Ev(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Wt(t,e))return;s.uniform4iv(this.addr,e),Xt(t,e)}}function wv(s,e){let t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function Av(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Wt(t,e))return;s.uniform2uiv(this.addr,e),Xt(t,e)}}function Rv(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Wt(t,e))return;s.uniform3uiv(this.addr,e),Xt(t,e)}}function Cv(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Wt(t,e))return;s.uniform4uiv(this.addr,e),Xt(t,e)}}function Pv(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Lu.compareFunction=t.isReversedDepthBuffer()?Lc:Ic,r=Lu):r=Sm,t.setTexture2D(e||r,i)}function Iv(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Tm,i)}function Lv(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Em,i)}function Dv(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||bm,i)}function Nv(s){switch(s){case 5126:return mv;case 35664:return gv;case 35665:return _v;case 35666:return xv;case 35674:return yv;case 35675:return vv;case 35676:return Mv;case 5124:case 35670:return Sv;case 35667:case 35671:return bv;case 35668:case 35672:return Tv;case 35669:case 35673:return Ev;case 5125:return wv;case 36294:return Av;case 36295:return Rv;case 36296:return Cv;case 35678:case 36198:case 36298:case 36306:case 35682:return Pv;case 35679:case 36299:case 36307:return Iv;case 35680:case 36300:case 36308:case 36293:return Lv;case 36289:case 36303:case 36311:case 36292:return Dv}}function Ov(s,e){s.uniform1fv(this.addr,e)}function Uv(s,e){let t=Jr(e,this.size,2);s.uniform2fv(this.addr,t)}function Fv(s,e){let t=Jr(e,this.size,3);s.uniform3fv(this.addr,t)}function Bv(s,e){let t=Jr(e,this.size,4);s.uniform4fv(this.addr,t)}function zv(s,e){let t=Jr(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function kv(s,e){let t=Jr(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Vv(s,e){let t=Jr(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function Hv(s,e){s.uniform1iv(this.addr,e)}function Gv(s,e){s.uniform2iv(this.addr,e)}function Wv(s,e){s.uniform3iv(this.addr,e)}function Xv(s,e){s.uniform4iv(this.addr,e)}function qv(s,e){s.uniform1uiv(this.addr,e)}function Yv(s,e){s.uniform2uiv(this.addr,e)}function Zv(s,e){s.uniform3uiv(this.addr,e)}function Kv(s,e){s.uniform4uiv(this.addr,e)}function Jv(s,e,t){let n=this.cache,i=e.length,r=zc(t,i);Wt(n,r)||(s.uniform1iv(this.addr,r),Xt(n,r));let a;this.type===s.SAMPLER_2D_SHADOW?a=Lu:a=Sm;for(let o=0;o!==i;++o)t.setTexture2D(e[o]||a,r[o])}function $v(s,e,t){let n=this.cache,i=e.length,r=zc(t,i);Wt(n,r)||(s.uniform1iv(this.addr,r),Xt(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||Tm,r[a])}function jv(s,e,t){let n=this.cache,i=e.length,r=zc(t,i);Wt(n,r)||(s.uniform1iv(this.addr,r),Xt(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Em,r[a])}function Qv(s,e,t){let n=this.cache,i=e.length,r=zc(t,i);Wt(n,r)||(s.uniform1iv(this.addr,r),Xt(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||bm,r[a])}function eM(s){switch(s){case 5126:return Ov;case 35664:return Uv;case 35665:return Fv;case 35666:return Bv;case 35674:return zv;case 35675:return kv;case 35676:return Vv;case 5124:case 35670:return Hv;case 35667:case 35671:return Gv;case 35668:case 35672:return Wv;case 35669:case 35673:return Xv;case 5125:return qv;case 36294:return Yv;case 36295:return Zv;case 36296:return Kv;case 35678:case 36198:case 36298:case 36306:case 35682:return Jv;case 35679:case 36299:case 36307:return $v;case 35680:case 36300:case 36308:case 36293:return jv;case 36289:case 36303:case 36311:case 36292:return Qv}}var Du=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Nv(t.type)}},Nu=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=eM(t.type)}},Ou=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let i=this.seq;for(let r=0,a=i.length;r!==a;++r){let o=i[r];o.setValue(e,t[o.id],n)}}},Pu=/(\w+)(\])?(\[|\.)?/g;function lm(s,e){s.seq.push(e),s.map[e.id]=e}function tM(s,e,t){let n=s.name,i=n.length;for(Pu.lastIndex=0;;){let r=Pu.exec(n),a=Pu.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){lm(t,c===void 0?new Du(o,s,e):new Nu(o,s,e));break}else{let u=t.map[o];u===void 0&&(u=new Ou(o),lm(t,u)),t=u}}}var Kr=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){let o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);tM(o,l,this)}let i=[],r=[];for(let a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?i.push(a):r.push(a);i.length>0&&(this.seq=i.concat(r))}setValue(e,t,n,i){let r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){let i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){let n=[];for(let i=0,r=e.length;i!==r;++i){let a=e[i];a.id in t&&n.push(a)}return n}};function cm(s,e,t){let n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}var nM=37297,iM=0;function sM(s,e){let t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}var hm=new De;function rM(s){Be._getMatrix(hm,Be.workingColorSpace,s);let e=`mat3( ${hm.elements.map(t=>t.toFixed(4))} )`;switch(Be.getTransfer(s)){case Ea:return[e,"LinearTransferOETF"];case Qe:return[e,"sRGBTransferOETF"];default:return Me("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function um(s,e,t){let n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+sM(s.getShaderSource(e),o)}else return r}function aM(s,e){let t=rM(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}var oM={[ru]:"Linear",[au]:"Reinhard",[ou]:"Cineon",[eo]:"ACESFilmic",[cu]:"AgX",[hu]:"Neutral",[lu]:"Custom"};function lM(s,e){let t=oM[e];return t===void 0?(Me("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Nc=new P;function cM(){Be.getLuminanceCoefficients(Nc);let s=Nc.x.toFixed(4),e=Nc.y.toFixed(4),t=Nc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function hM(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(uo).join(`
`)}function uM(s){let e=[];for(let t in s){let n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function dM(s,e){let t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){let r=s.getActiveAttrib(e,i),a=r.name,o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function uo(s){return s!==""}function dm(s,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function fm(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var fM=/^[ \t]*#include +<([\w\d./]+)>/gm;function Uu(s){return s.replace(fM,mM)}var pM=new Map;function mM(s,e){let t=ke[e];if(t===void 0){let n=pM.get(e);if(n!==void 0)t=ke[n],Me('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Uu(t)}var gM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function pm(s){return s.replace(gM,_M)}function _M(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function mm(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}var xM={[Qa]:"SHADOWMAP_TYPE_PCF",[Gr]:"SHADOWMAP_TYPE_VSM"};function yM(s){return xM[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var vM={[ps]:"ENVMAP_TYPE_CUBE",[qs]:"ENVMAP_TYPE_CUBE",[to]:"ENVMAP_TYPE_CUBE_UV"};function MM(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":vM[s.envMapMode]||"ENVMAP_TYPE_CUBE"}var SM={[qs]:"ENVMAP_MODE_REFRACTION"};function bM(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":SM[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}var TM={[su]:"ENVMAP_BLENDING_MULTIPLY",[Ip]:"ENVMAP_BLENDING_MIX",[Lp]:"ENVMAP_BLENDING_ADD"};function EM(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":TM[s.combine]||"ENVMAP_BLENDING_NONE"}function wM(s){let e=s.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function AM(s,e,t,n){let i=s.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=yM(t),c=MM(t),h=bM(t),u=EM(t),d=wM(t),f=hM(t),g=uM(r),_=i.createProgram(),p,m,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);let S=y+p+a,M=y+m+o,E=cm(i,i.VERTEX_SHADER,S),T=cm(i,i.FRAGMENT_SHADER,M);i.attachShader(_,E),i.attachShader(_,T),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(C){if(s.debug.checkShaderErrors){let U=i.getProgramInfoLog(_)||"",H=i.getShaderInfoLog(E)||"",G=i.getShaderInfoLog(T)||"",D=U.trim(),F=H.trim(),B=G.trim(),J=!0,Q=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(J=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,E,T);else{let oe=um(i,E,"vertex"),ge=um(i,T,"fragment");Ae("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,side:Kt,transparent:!0,depthWrite:!1,blending:Gt}),i=new $e(t,n);return i.name=e==="gold"?"gold atmospheric glow":"blue atmospheric glow",i}function xT(s){let e=new zt;e.name="Brazil to Dubai route";let t=Xg(uf.lat,uf.lon,s*1.045),n=Xg(df.lat,df.lon,s*1.045),i=AT(t,n,s,.24),r=new ls(i,128,s*.015,10,!1),a=new vt({color:5556735,transparent:!0,opacity:.2,blending:Gt,depthWrite:!1}),o=new $e(r,a),l=new ls(i,128,s*.0048,8,!1),c=new vt({color:16762237,transparent:!0,opacity:.92,blending:Gt,depthWrite:!1}),h=new $e(l,c);e.add(o,h);let u=new vt({color:16765835,blending:Gt,transparent:!0,opacity:1}),d=new vt({color:6543615,blending:Gt,transparent:!0,opacity:1});e.add(Wg(t,s,u)),e.add(Wg(n,s,d));let f=ff(uf.label,{width:420,height:140,fontSize:52,color:"rgba(255, 220, 160, 0.95)",glow:"rgba(255, 178, 74, 0.5)",underline:"rgba(255, 200, 130, 0.82)"});f.position.copy(t.clone().normalize().multiplyScalar(s*1.38)),f.position.y+=s*.12,f.scale.set(s*.72,s*.24,1),f.userData.basePosition=f.position.clone(),f.userData.baseScale=f.scale.clone();let g=ff(df.label,{width:420,height:140,fontSize:52,color:"rgba(210, 242, 255, 0.95)",glow:"rgba(83, 202, 255, 0.55)",underline:"rgba(103, 220, 255, 0.82)"});g.position.copy(n.clone().normalize().multiplyScalar(s*1.38)),g.position.y+=s*.12,g.scale.set(s*.72,s*.24,1),g.userData.basePosition=g.position.clone(),g.userData.baseScale=g.scale.clone(),e.add(f,g);let _=[];for(let p=0;p<3;p+=1){let m=yT(s);m.position.copy(i.getPointAt(p/3)),e.add(m),_.push({object:m,curve:i,speed:.12+p*.012,offset:p*.32,baseScale:1})}return{group:e,flights:_,labels:[f,g]}}function Wg(s,e,t){let n=new zt;n.position.copy(s);let i=new $e(new Ln(e*.022,18,18),t),r=Zg(t.color,e*.2,.72);return n.add(i,r),n}function yT(s){let e=new zt,t=new vt({color:16777215,transparent:!0,opacity:.95,blending:Gt,depthWrite:!1}),n=new $e(new Ln(s*.012,12,12),t),i=Zg(new be(16766362),s*.14,.75);return e.add(n,i),e}function vT(s,e){let t=new zt;t.name="timeline rail";let n=s.map(o=>new P(o.x,o.y-e*1.32,o.z-.08)),i=new Hs(n,!1,"catmullrom",.18),r=new $e(new ls(i,180,e*.022,8,!1),new vt({color:4167167,transparent:!0,opacity:.13,blending:Gt,depthWrite:!1})),a=new $e(new ls(i,180,e*.004,8,!1),new vt({color:12443647,transparent:!0,opacity:.62,blending:Gt,depthWrite:!1}));return t.add(r,a),n.forEach((o,l)=>{let c=new $e(new Ln(e*.035,18,18),new vt({color:l===0?16760182:7916287,transparent:!0,opacity:.92,blending:Gt,depthWrite:!1}));c.position.copy(o),t.add(c)}),t}function Yg(s){return new Jt({uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio||1,2)},uParallax:{value:new le},uOpacity:{value:s}},vertexShader:`
    ...
    `,vertexColors:!0,transparent:!0,depthWrite:!1,blending:Gt})}function MT(s){let e=new Nt,t=new Float32Array(s*3),n=new Float32Array(s*3),i=new Float32Array(s),r=new Float32Array(s),a=new be;for(let c=0;c<s;c+=1){let h=c*3;t[h]=pt.randFloatSpread(95),t[h+1]=pt.randFloatSpread(46),t[h+2]=pt.randFloat(-88,-13);let u=Math.random();a.setHSL(u>.84?.09:.58,u>.84?.6:.38,pt.randFloat(.66,1)),n[h]=a.r,n[h+1]=a.g,n[h+2]=a.b,i[c]=pt.randFloat(.42,Math.random()>.982?2.1:1.35),r[c]=Math.random()}e.setAttribute("position",new tt(t,3)),e.setAttribute("color",new tt(n,3)),e.setAttribute("aSize",new tt(i,1)),e.setAttribute("aTwinkle",new tt(r,1));let o=Yg(.64),l=new os(e,o);return l.name="deep starfield",{points:l,material:o}}function ST(s){let e=new Nt,t=new Float32Array(s*3),n=new Float32Array(s*3),i=new Float32Array(s),r=new Float32Array(s),a=new be;for(let c=0;c<s;c+=1){let h=c*3;t[h]=pt.randFloatSpread(48),t[h+1]=pt.randFloat(-12,10),t[h+2]=pt.randFloat(-36,-8);let u=Math.random()>.55?.08:.56;a.setHSL(u,pt.randFloat(.45,.85),pt.randFloat(.35,.72)),n[h]=a.r,n[h+1]=a.g,n[h+2]=a.b,i[c]=pt.randFloat(.9,3.8),r[c]=Math.random()}e.setAttribute("position",new tt(t,3)),e.setAttribute("color",new tt(n,3)),e.setAttribute("aSize",new tt(i,1)),e.setAttribute("aTwinkle",new tt(r,1));let o=Yg(.04),l=new os(e,o);return l.name="subtle cosmic dust",{points:l,material:o}}function bT(){let s=new zt;s.name="giant upper orange planet";let e=5.35,t=wT(),n=new $e(new Ln(e,128,128),new vt({map:t,color:16747566}));n.name="orange planet surface";let i=new $e(new Ln(e*1.045,96,96),new Jt({uniforms:{glowColor:{value:new be(16747061)},power:{value:1.8}},vertexShader:`
        varying vec3 vNormal;
        varying vec3 vWorldPosition;
